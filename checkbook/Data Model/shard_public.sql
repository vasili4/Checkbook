...
CREATE INDEX idx_ma_agreement_id_all_disb_trans ON all_disbursement_transactions(master_agreement_id);
 ...
 -- 12/18/2014 (based on slow queries from new relic)
 
CREATE INDEX idx_vendor_id_disb_line_item_dets ON disbursement_line_item_details(vendor_id);
CREATE INDEX idx_vendor_name_disb_line_item_dets ON disbursement_line_item_details(vendor_name);
CREATE INDEX idx_department_id_disb_line_item_dets ON disbursement_line_item_details(department_id);
CREATE INDEX idx_department_name_disb_line_item_dets ON disbursement_line_item_details(department_name);
CREATE INDEX idx_exp_object_name_disb_line_item_dets ON disbursement_line_item_details(expenditure_object_name);
CREATE INDEX idx_chk_eft_iss_date_disb_line_item_dets ON disbursement_line_item_details(check_eft_issued_date);
...
CREATE INDEX idx_vendor_id_aggregateon_spending_coa_entities ON aggregateon_spending_coa_entities(vendor_id);
CREATE INDEX idx_agency_id_aggregateon_spending_coa_entities ON aggregateon_spending_coa_entities(agency_id);
CREATE INDEX idx_year_id_aggregateon_spending_coa_entities ON aggregateon_spending_coa_entities(year_id);


CREATE INDEX idx_vendor_id_cont_spen_trans ON contracts_spending_transactions(vendor_id);
CREATE INDEX idx_award_method_id_cont_spen_trans ON contracts_spending_transactions(award_method_id);


CREATE INDEX idx_vendor_id_cont_mw_spen_trans ON contracts_mwbe_spending_transactions(vendor_id);
CREATE INDEX idx_award_method_id_cont_mw_spen_trans ON contracts_mwbe_spending_transactions(award_method_id);
...
CREATE INDEX idx_vendor_id_aggregateon_mwbe_spending_coa_entities ON aggregateon_mwbe_spending_coa_entities(vendor_id);
CREATE INDEX idx_agency_id_aggregateon_mwbe_spending_coa_entities ON aggregateon_mwbe_spending_coa_entities(agency_id);
CREATE INDEX idx_year_id_aggregateon_mwbe_spending_coa_entities ON aggregateon_mwbe_spending_coa_entities(year_id);
