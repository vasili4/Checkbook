...
CREATE EXTERNAL TABLE ext_stg_budget_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/BUDGET_feed.txt'
...
CREATE EXTERNAL TABLE ext_stg_coa_agency_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_agency_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_budget_code_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_budget_code_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_department_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_department_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_expenditure_object_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_expenditure_object_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_location_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_location_object_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_object_class_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_object_class_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_revenue_category_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_revenue_category_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_revenue_class_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_revenue_class_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_coa_revenue_source_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_revenue_source_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_con_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/CON_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
--
-- Name: ext_stg_edc_contract_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
) FORMAT 'csv' (delimiter E',' null E'' escape E'~' quote E'"' fill missing fields)
ENCODING 'UTF8';


ALTER EXTERNAL TABLE etl.ext_stg_edc_contract_data_feed OWNER TO gpadmin;
...
CREATE EXTERNAL TABLE ext_stg_fms_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/FMS_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_fmsv_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/FMSV_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_funding_class (
    ...
    'gpfdist://mdw1:8082/datafiles/COA_funding_class_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_mag_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/MAG_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_oaisis_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/OAISIS_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_pension_fund (
    ...
    'gpfdist://mdw1:8082/datafiles/police_pension_fund.txt'
) FORMAT 'text' (delimiter E',' null E'\\N' escape E'"' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_pms_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/PMS_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_pms_summary_data_feed (
    ...
    'gpfdist://mdw1:8082/datafiles/PMS_summary_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_revenue (
    ...
    'gpfdist://mdw1:8082/datafiles/Revenue_feed.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
CREATE EXTERNAL TABLE ext_stg_revenue_budget (
    ...
    'gpfdist://mdw1:8082/datafiles/revenue_budget.txt'
) FORMAT 'text' (delimiter E'|' null E'\\N' escape E'~' fill missing fields)
ENCODING 'UTF8';
...
--
-- Name: ext_stg_tdc_contract_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_tdc_contract_data_feed OWNER TO gpadmin;
...
--
-- Name: ext_stg_edc_contract_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_edc_contract_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_edc_contract_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_edc_contract_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_edc_contract_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_edc_contract_data_feed TO apache;
...
--
-- Name: ext_stg_tdc_contract_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_tdc_contract_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_tdc_contract_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_tdc_contract_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_tdc_contract_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_tdc_contract_data_feed TO apache;
