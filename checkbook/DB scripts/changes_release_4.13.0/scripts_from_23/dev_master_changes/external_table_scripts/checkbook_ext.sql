...
--
-- Name: ext_stg_coa_agency_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_agency_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_budget_code_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_budget_code_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_department_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_department_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_expenditure_object_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_expenditure_object_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_location_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--

CREATE EXTERNAL TABLE ext_stg_coa_location_feed (
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_location_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_object_class_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_object_class_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_revenue_category_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_revenue_category_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_revenue_class_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_revenue_class_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_revenue_source_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_coa_revenue_source_feed OWNER TO gpadmin;

--
-- Name: ext_stg_con_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_con_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_fms_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_fms_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_fmsv_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--

CREATE EXTERNAL TABLE ext_stg_fmsv_data_feed (
    record_type character(1),
    doc_dept_cd character varying,
...
ALTER EXTERNAL TABLE etl.ext_stg_fmsv_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_funding_class; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--

CREATE EXTERNAL TABLE ext_stg_funding_class (
    doc_dept_cd character varying,
    fy character varying,
...
ALTER EXTERNAL TABLE etl.ext_stg_funding_class OWNER TO gpadmin;

--
-- Name: ext_stg_mag_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_mag_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_oaisis_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_oaisis_feed OWNER TO gpadmin;

--
-- Name: ext_stg_pension_fund; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_pension_fund OWNER TO gpadmin;

--
-- Name: ext_stg_pms_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_pms_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_pms_summary_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_pms_summary_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_revenue; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_revenue OWNER TO gpadmin;

--
-- Name: ext_stg_revenue_budget; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--

CREATE EXTERNAL TABLE ext_stg_revenue_budget (
...
ALTER EXTERNAL TABLE etl.ext_stg_revenue_budget OWNER TO gpadmin;

--
-- Name: ext_stg_scntrc_bus_type_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_scntrc_bus_type_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_scntrc_details_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_scntrc_details_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_scntrc_pymt_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_scntrc_pymt_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_scntrc_status_data_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--
...
ALTER EXTERNAL TABLE etl.ext_stg_scntrc_status_data_feed OWNER TO gpadmin;

--
-- Name: ext_stg_budget_feed; Type: EXTERNAL TABLE; Schema: etl; Owner: gpadmin; Tablespace: 
--

CREATE EXTERNAL TABLE ext_stg_budget_feed
(
...
ALTER EXTERNAL TABLE etl.ext_stg_budget_feed OWNER TO gpadmin;

--
-- Name: ext_stg_coa_agency_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_agency_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_agency_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_agency_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_agency_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_agency_feed TO apache;


--
-- Name: ext_stg_coa_budget_code_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_budget_code_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_budget_code_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_budget_code_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_budget_code_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_budget_code_feed TO apache;


--
-- Name: ext_stg_coa_department_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_department_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_department_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_department_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_department_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_department_feed TO apache;


--
-- Name: ext_stg_coa_expenditure_object_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_expenditure_object_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_expenditure_object_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_expenditure_object_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_expenditure_object_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_expenditure_object_feed TO apache;


--
-- Name: ext_stg_coa_location_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_location_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_location_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_location_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_location_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_location_feed TO apache;


--
-- Name: ext_stg_coa_object_class_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_object_class_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_object_class_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_object_class_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_object_class_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_object_class_feed TO apache;


--
-- Name: ext_stg_coa_revenue_category_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_revenue_category_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_revenue_category_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_revenue_category_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_revenue_category_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_revenue_category_feed TO apache;


--
-- Name: ext_stg_coa_revenue_class_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_revenue_class_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_revenue_class_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_revenue_class_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_revenue_class_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_revenue_class_feed TO apache;


--
-- Name: ext_stg_coa_revenue_source_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_coa_revenue_source_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_coa_revenue_source_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_coa_revenue_source_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_coa_revenue_source_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_coa_revenue_source_feed TO apache;


--
-- Name: ext_stg_con_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_con_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_con_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_con_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_con_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_con_data_feed TO apache;


--
-- Name: ext_stg_fms_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_fms_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_fms_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_fms_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_fms_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_fms_data_feed TO apache;


--
-- Name: ext_stg_fmsv_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_fmsv_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_fmsv_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_fmsv_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_fmsv_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_fmsv_data_feed TO apache;


--
-- Name: ext_stg_funding_class; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_funding_class FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_funding_class FROM gpadmin;
GRANT ALL ON TABLE ext_stg_funding_class TO gpadmin;
GRANT SELECT ON TABLE ext_stg_funding_class TO webuser1;
GRANT SELECT ON TABLE ext_stg_funding_class TO apache;


--
-- Name: ext_stg_mag_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_mag_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_mag_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_mag_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_mag_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_mag_data_feed TO apache;


--
-- Name: ext_stg_oaisis_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_oaisis_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_oaisis_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_oaisis_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_oaisis_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_oaisis_feed TO apache;


--
-- Name: ext_stg_pension_fund; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_pension_fund FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_pension_fund FROM gpadmin;
GRANT ALL ON TABLE ext_stg_pension_fund TO gpadmin;
GRANT SELECT ON TABLE ext_stg_pension_fund TO webuser1;
GRANT SELECT ON TABLE ext_stg_pension_fund TO apache;


--
-- Name: ext_stg_pms_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_pms_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_pms_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_pms_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_pms_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_pms_data_feed TO apache;


--
-- Name: ext_stg_pms_summary_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_pms_summary_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_pms_summary_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_pms_summary_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_pms_summary_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_pms_summary_data_feed TO apache;


--
-- Name: ext_stg_revenue; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_revenue FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_revenue FROM gpadmin;
GRANT ALL ON TABLE ext_stg_revenue TO gpadmin;
GRANT SELECT ON TABLE ext_stg_revenue TO webuser1;
GRANT SELECT ON TABLE ext_stg_revenue TO apache;


--
-- Name: ext_stg_revenue_budget; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_revenue_budget FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_revenue_budget FROM gpadmin;
GRANT ALL ON TABLE ext_stg_revenue_budget TO gpadmin;
GRANT SELECT ON TABLE ext_stg_revenue_budget TO webuser1;
GRANT SELECT ON TABLE ext_stg_revenue_budget TO apache;


--
-- Name: ext_stg_scntrc_bus_type_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_scntrc_bus_type_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_scntrc_bus_type_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_scntrc_bus_type_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_scntrc_bus_type_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_scntrc_bus_type_data_feed TO apache;


--
-- Name: ext_stg_scntrc_details_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_scntrc_details_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_scntrc_details_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_scntrc_details_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_scntrc_details_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_scntrc_details_data_feed TO apache;


--
-- Name: ext_stg_scntrc_pymt_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_scntrc_pymt_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_scntrc_pymt_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_scntrc_pymt_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_scntrc_pymt_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_scntrc_pymt_data_feed TO apache;


--
-- Name: ext_stg_scntrc_status_data_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_scntrc_status_data_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_scntrc_status_data_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_scntrc_status_data_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_scntrc_status_data_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_scntrc_status_data_feed TO apache;


--
-- Name: ext_stg_budget_feed; Type: ACL; Schema: etl; Owner: gpadmin
--

REVOKE ALL ON TABLE ext_stg_budget_feed FROM PUBLIC;
REVOKE ALL ON TABLE ext_stg_budget_feed FROM gpadmin;
GRANT ALL ON TABLE ext_stg_budget_feed TO gpadmin;
GRANT SELECT ON TABLE ext_stg_budget_feed TO webuser1;
GRANT SELECT ON TABLE ext_stg_budget_feed TO apache;
