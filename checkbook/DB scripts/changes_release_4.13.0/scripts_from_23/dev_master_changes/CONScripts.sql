...
BEGIN
	...
	*/
	...
	-- updating scntrc_status field in the history_agreement table
	UPDATE history_agreement a
	...
	AND b.date >= '2015-07-01' AND c.document_code in ('CT1','CTA1','CT2') and a.scntrc_status is NULL;
