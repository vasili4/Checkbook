...
BEGIN	      
	...
	INSERT INTO budget(budget_fiscal_year, fund_class_id, agency_history_id, department_history_id, budget_code_id, 
			   ...
			   post_closing_adjustment_amount_original,post_closing_adjustment_amount, total_expenditure_amount, 
	...
	SELECT budget_fiscal_year, fund_class_id, agency_history_id, department_history_id, budget_code_id, 
		...
		post_closing_adjustment_amount as post_closing_adjustment_amount_original, coalesce(post_closing_adjustment_amount,0) as post_closing_adjustment_amount,  total_expenditure_amount, 
