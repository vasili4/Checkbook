...
INSERT INTO vendor_min_bus_type(vendor_history_id, business_type_id, minority_type_id, business_type_code, business_type_name, minority_type_name ) 
SELECT a.vendor_history_id, a.business_type_id as business_type_id,
