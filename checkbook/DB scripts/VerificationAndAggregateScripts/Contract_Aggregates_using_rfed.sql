 ...
 */
 ...
 INSERT INTO aggregateon_contracts_expense 
SELECT m.original_agreement_id, p.expenditure_object_id, p.expenditure_object_name, m.encumbered_amount,coalesce(n.spending_amount_disb,0) as spending_amount_disb, m.spending_amount
FROM
 (SELECT a.original_agreement_id, c.expenditure_object_id,  sum(b.line_amount) as encumbered_amount, sum(b.rfed_line_amount) as spending_amount
 ...
 (SELECT agreement_id as original_agreement_id, expenditure_object_id, sum(check_amount) as spending_amount_disb
