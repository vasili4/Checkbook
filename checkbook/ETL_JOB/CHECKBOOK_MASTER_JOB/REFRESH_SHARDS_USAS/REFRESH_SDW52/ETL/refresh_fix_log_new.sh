...
then
psql -h mdw -U gpadmin --dbname USASpending -c "insert into refresh_shards_status (shard_name,step_name, status_flag) values ( 'Shard sdw52', 'Step 3',0)"
else
psql -h mdw -U gpadmin --dbname USASpending -c "insert into refresh_shards_status (shard_name,step_name, status_flag) values ( 'Shard sdw52', 'Step 3',1)"
fi
else
psql -h mdw -U gpadmin --dbname USASpending -c "insert into refresh_shards_status (shard_name,step_name, status_flag) values ( 'Shard sdw52', 'Step 3',0)"
fi
