...
source /vol1/greenplum-db/greenplum_path.sh
...
gpssh  -h mdw4 -e "/home/gpadmin/ETL/QA/refresh.sh"

#Check for any errors on the shards and fix them
gpssh -h mdw4 -e "/home/gpadmin/ETL/QA/refresh_fix.sh"
gpssh -h mdw4 -e "/home/gpadmin/ETL/QA/refresh_fix_log.sh"
