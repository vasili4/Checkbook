      ...
      */
      ...
      var gravity = 'w' //Can be 'n','s','e','w'. Determines how tooltip is positioned.
        ...
        offset = {
          left: 0,
          top: 0
        } //Offset of tooltip against the pointer
        ,
  ...
  */
  ...
  nv.models.boxPlot = function() {
    ...
    var margin = {
      ...
      container = null,
      xDomain, yDomain, xRange, yRange, dispatch = d3.dispatch('elementMouseover', 'elementMouseout', 'elementMousemove', 'renderEnd'),
      duration = 250,
      maxBoxWidth = null;
    ...
    function chart(selection) {
      ...
      selection.each(function(data) {
        ...
        var box_width = function() {
          return (maxBoxWidth === null ? x.rangeBand() * .9 : Math.min(75, x.rangeBand() * .9));
        };
        var box_left = function() {
          return x.rangeBand() * .45 - box_width() / 2;
        };
  ...
  nv.models.candlestickBar = function() {
    ...
    var margin = {
      ...
      color = nv.utils.defaultColor(),
      interactive = false,
      xDomain, yDomain, xRange, yRange, dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'renderEnd', 'chartClick', 'elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout', 'elementMousemove');
    ...
    function chart(selection) {
      ...
      selection.each(function(data) {
        ...
        if (showLegend) {
          ...
          //using custom positioning rather than from source
          wrap.select('.nv-legendWrap')
            .attr('transform', 'translate(' + -430 + ',' + 420 + ')');
      ...
      selection.each(function(data) {
        ...
        if (showControls) {
          ...
          g.select('.nv-controlsWrap')
            .datum(controlsData)
            //using custom positioning rather than from source
            .attr('transform', 'translate(720,' + (-margin.top) + ')')
            // .attr('transform', 'translate(0,' + (-margin.top) + ')')
            .call(controls);
        }
