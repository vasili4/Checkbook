...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.address to stdout csv"' ON SEGMENT 0 
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_spending_coa_entities to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_spending_contract to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_spending_vendor to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_spending_vendor_exp_object to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE budget__0 (
    ...
    job_id bigint
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.budget to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE disbursement__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.disbursement to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE disbursement_line_item__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone    
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.disbursement_line_item to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE disbursement_line_item_details__0 (
	...
	job_id bigint
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.disbursement_line_item_details to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE VIEW disbursement_line_item_details AS
    ...
    disbursement_line_item_details__0.master_contract_document_code, disbursement_line_item_details__0.oge_contract_number, disbursement_line_item_details__0.oge_budget_name,  disbursement_line_item_details__0.file_type,disbursement_line_item_details__0.load_id, disbursement_line_item_details__0.last_modified_date, 
...
CREATE EXTERNAL WEB TABLE revenue_details__0 (
	...
	last_modified_date timestamp without time zone,
	job_id bigint
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.revenue_details to stdout csv"' ON SEGMENT 0 
FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE history_agreement__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.history_agreement to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE history_agreement_accounting_line__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.history_agreement_accounting_line to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE history_agreement_commodity__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.history_agreement_commodity to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE history_agreement_worksite__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.history_agreement_worksite to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE history_master_agreement__0 (
  ...
  created_date timestamp without time zone,
  updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.history_master_agreement to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE VIEW history_master_agreement AS
    ...
    history_master_agreement__0.contract_number, history_master_agreement__0.original_master_agreement_id, history_master_agreement__0.num_associated_contracts, history_master_agreement__0.original_version_flag, history_master_agreement__0.latest_flag,        
...
CREATE EXTERNAL WEB TABLE ref_address_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_address_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_agency__0 (
    ...
    created_load_id integer,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_agency to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE VIEW ref_agency AS
    SELECT ref_agency__0.agency_id, ref_agency__0.agency_code, ref_agency__0.agency_name, ref_agency__0.agency_short_name,ref_agency__0.original_agency_name,ref_agency__0.is_display, ref_agency__0.is_oge_agency, ref_agency__0.created_date, ref_agency__0.updated_date, ref_agency__0.created_load_id, ref_agency__0.updated_load_id FROM ONLY ref_agency__0;
...
CREATE EXTERNAL WEB TABLE ref_agency_history__0 (
    ...
    created_date timestamp without time zone,
    load_id integer    
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_agency_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_agreement_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_agreement_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_award_category__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_award_category to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_award_method__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_award_method to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_budget_code__0 (
    ...
    updated_date timestamp without time zone,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_budget_code to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_business_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_business_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_business_type_status__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_business_type_status to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_data_source__0 (
    ...
    description character varying,
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_data_source to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
*/
--
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_date to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_department__0 (
    ...
    created_load_id integer,
    updated_load_id integer    
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_department to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_department_history__0 (
    ...
    created_date timestamp without time zone,
    load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_department_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_document_code__0 (
    ...
    document_name character varying,
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_document_code to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_cancel_reason__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_cancel_reason to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_cancel_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_cancel_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_object__0 (
    ...
    created_load_id integer,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_object to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_object_history__0 (
    ...
    created_date timestamp without time zone,
    load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_object_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_privacy_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_privacy_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_expenditure_status__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_expenditure_status to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_fund_class__0 (
    ...
    created_load_id integer,
    created_date timestamp without time zone    
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_fund_class to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_funding_class__0 (
    ...
    created_load_id integer,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_funding_class to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_funding_source__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_funding_source to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_location__0 (
    ...
    created_load_id integer,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_location to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_location_history__0 (
    ...
    created_date timestamp without time zone,
    load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_location_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_minority_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_minority_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_miscellaneous_vendor__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_miscellaneous_vendor to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_month to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_object_class__0 (
    ...
    created_load_id integer,
    updated_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_object_class to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_object_class_history__0 (
    ...
    created_date timestamp without time zone,
    load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_object_class_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_revenue_category__0 (
    ...
    updated_load_id integer,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_revenue_category to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_revenue_class__0 (
    ...
    updated_load_id integer,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_revenue_class to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_revenue_source__0 (
    ...
    updated_date timestamp without time zone,
    created_load_id integer
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_revenue_source to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_spending_category__0 (
    ...
    display_order smallint
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_spending_category to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_year__0 (
    year_id smallint,
    year_value smallint
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_year to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE revenue__0 (
    ...
    load_id integer,
    created_date timestamp without time zone  
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.revenue to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE vendor__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.vendor to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE vendor_address__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.vendor_address to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE vendor_business_type__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.vendor_business_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE vendor_history__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.vendor_history to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.vendor_details to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_fiscal_period to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_pay_frequency to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_revenue_category_funding_class to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_revenue_category_funding_by_year to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_amount_basis to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE employee__0 (
  ...
  EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.employee to stdout csv"' ON SEGMENT 0 
   FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE employee_history__0 (
  ...
  EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.employee_history to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE payroll__0(
	...
	EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.payroll to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	
...
CREATE EXTERNAL WEB TABLE aggregateon_payroll_employee_agency__0(
	...
	other_payments numeric(16,2),
	gross_pay numeric(16,2) )
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_employee_agency to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE aggregateon_payroll_agency__0(	
	...
	annual_salary numeric(16,2))
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_agency to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
CREATE  EXTERNAL WEB TABLE aggregateon_payroll_coa_month__0(	
	...
	other_payments numeric(16,2),
	gross_pay numeric(16,2) )
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_coa_month to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
 ...
 CREATE  EXTERNAL WEB TABLE aggregateon_payroll_year__0(	
	...
	total_hourly_employees int,
	total_overtime_employees int)
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_year to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	
  ...
  CREATE VIEW aggregateon_payroll_year AS
	...
	other_payments numeric(16,2),
	gross_pay numeric(16,2) )
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_employee_agency_month to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE aggregateon_payroll_agency_month__0(	
	...
	total_overtime_employees int,
	annual_salary numeric(16,2))
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_agency_month to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
 ...
 CREATE  EXTERNAL WEB TABLE aggregateon_payroll_year_and_month__0(	
	...
	total_hourly_employees int,
	total_overtime_employees int)
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_payroll_year_and_month to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	
  ...
  CREATE VIEW aggregateon_payroll_year_and_month AS
	...
	(
	 ...
	 EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.revenue_budget to stdout csv"' ON SEGMENT 0 
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.payroll_summary to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.agreement_snapshot_expanded to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.agreement_snapshot_expanded_cy to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	 
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_cumulative_spending to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	 
  ...
  CREATE VIEW aggregateon_contracts_cumulative_spending AS
  	...
  	aggregateon_contracts_cumulative_spending__0.fiscal_year_id,
		...
		aggregateon_contracts_cumulative_spending__0.display_agency_id,aggregateon_contracts_cumulative_spending__0.display_vendor_id,
...
CREATE EXTERNAL WEB TABLE aggregateon_contracts_cumulative_spending_no_vendor__0(
	original_agreement_id bigint,
	fiscal_year smallint,
	fiscal_year_id smallint,
	document_code_id smallint,
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_cumulative_spending_no_vendor to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	 
  
  CREATE VIEW aggregateon_contracts_cumulative_spending_no_vendor AS
  	SELECT aggregateon_contracts_cumulative_spending_no_vendor__0.original_agreement_id,aggregateon_contracts_cumulative_spending_no_vendor__0.fiscal_year,
  	aggregateon_contracts_cumulative_spending_no_vendor__0.fiscal_year_id,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.document_code_id,aggregateon_contracts_cumulative_spending_no_vendor__0.master_agreement_yn,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.description,aggregateon_contracts_cumulative_spending_no_vendor__0.contract_number,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.award_method_id,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.agency_id,aggregateon_contracts_cumulative_spending_no_vendor__0.industry_type_id,aggregateon_contracts_cumulative_spending_no_vendor__0.award_size_id,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.original_contract_amount,aggregateon_contracts_cumulative_spending_no_vendor__0.maximum_contract_amount,aggregateon_contracts_cumulative_spending_no_vendor__0.spending_amount_disb,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.spending_amount,aggregateon_contracts_cumulative_spending_no_vendor__0.current_year_spending_amount,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.dollar_difference,aggregateon_contracts_cumulative_spending_no_vendor__0.percent_difference,
  		aggregateon_contracts_cumulative_spending_no_vendor__0.display_agency_id, aggregateon_contracts_cumulative_spending_no_vendor__0.status_flag,aggregateon_contracts_cumulative_spending_no_vendor__0.type_of_year
  	FROM 	  aggregateon_contracts_cumulative_spending_no_vendor__0;  
	


CREATE EXTERNAL WEB TABLE aggregateon_contracts_cumulative_spending_visualizations__0(
	original_agreement_id bigint,
	fiscal_year smallint,
	fiscal_year_id smallint,
	document_code_id smallint,
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_cumulative_spending_visualizations to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	 
  
  CREATE VIEW aggregateon_contracts_cumulative_spending_visualizations AS
  	SELECT aggregateon_contracts_cumulative_spending_visualizations__0.original_agreement_id,aggregateon_contracts_cumulative_spending_visualizations__0.fiscal_year,
  	aggregateon_contracts_cumulative_spending_visualizations__0.fiscal_year_id,
  		aggregateon_contracts_cumulative_spending_visualizations__0.document_code_id,aggregateon_contracts_cumulative_spending_visualizations__0.master_agreement_yn,
  		aggregateon_contracts_cumulative_spending_visualizations__0.description,aggregateon_contracts_cumulative_spending_visualizations__0.contract_number,
  		aggregateon_contracts_cumulative_spending_visualizations__0.vendor_id,aggregateon_contracts_cumulative_spending_visualizations__0.award_method_id,  		aggregateon_contracts_cumulative_spending_visualizations__0.agency_id,aggregateon_contracts_cumulative_spending_visualizations__0.industry_type_id,aggregateon_contracts_cumulative_spending_visualizations__0.award_size_id, aggregateon_contracts_cumulative_spending_visualizations__0.original_contract_amount, aggregateon_contracts_cumulative_spending_visualizations__0.maximum_contract_amount,aggregateon_contracts_cumulative_spending_visualizations__0.spending_amount_disb,
  		aggregateon_contracts_cumulative_spending_visualizations__0.spending_amount,aggregateon_contracts_cumulative_spending_visualizations__0.current_year_spending_amount,
  		aggregateon_contracts_cumulative_spending_visualizations__0.dollar_difference,aggregateon_contracts_cumulative_spending_visualizations__0.percent_difference,
		aggregateon_contracts_cumulative_spending_visualizations__0.display_agency_id,aggregateon_contracts_cumulative_spending_visualizations__0.display_vendor_id,
  		aggregateon_contracts_cumulative_spending_visualizations__0.display_vendor_name, aggregateon_contracts_cumulative_spending_visualizations__0.is_vendor_page, aggregateon_contracts_cumulative_spending_visualizations__0.status_flag, aggregateon_contracts_cumulative_spending_visualizations__0.type_of_year
  	FROM 	  aggregateon_contracts_cumulative_spending_visualizations__0;
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_spending_by_month to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_total_contracts to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE aggregateon_total_contracts_no_vendor__0
(
	fiscal_year smallint,
	fiscal_year_id smallint,
	award_method_id smallint,
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_total_contracts_no_vendor to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  
  CREATE VIEW aggregateon_total_contracts_no_vendor AS
  	SELECT aggregateon_total_contracts_no_vendor__0.fiscal_year,aggregateon_total_contracts_no_vendor__0.fiscal_year_id,aggregateon_total_contracts_no_vendor__0.award_method_id,
  	aggregateon_total_contracts_no_vendor__0.agency_id, aggregateon_total_contracts_no_vendor__0.industry_type_id, aggregateon_total_contracts_no_vendor__0.award_size_id,
  	aggregateon_total_contracts_no_vendor__0.total_contracts,aggregateon_total_contracts_no_vendor__0.total_commited_contracts,	aggregateon_total_contracts_no_vendor__0.total_master_agreements,
  	aggregateon_total_contracts_no_vendor__0.total_standalone_contracts,aggregateon_total_contracts_no_vendor__0.total_revenue_contracts,aggregateon_total_contracts_no_vendor__0.total_revenue_contracts_amount,
  	aggregateon_total_contracts_no_vendor__0.total_commited_contracts_amount,aggregateon_total_contracts_no_vendor__0.total_contracts_amount,aggregateon_total_contracts_no_vendor__0.total_spending_amount_disb,
  	aggregateon_total_contracts_no_vendor__0.total_spending_amount,aggregateon_total_contracts_no_vendor__0.status_flag,aggregateon_total_contracts_no_vendor__0.type_of_year
  	FROM   aggregateon_total_contracts_no_vendor__0;
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_department to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  

  CREATE VIEW aggregateon_contracts_department AS
  	SELECT aggregateon_contracts_department__0.document_code_id,aggregateon_contracts_department__0.agency_id,aggregateon_contracts_department__0.department_id,aggregateon_contracts_department__0.fiscal_year,
   ...
   CREATE EXTERNAL WEB TABLE aggregateon_contracts_department_no_vendor__0(
 	document_code_id smallint,
	agency_id smallint,
	department_id integer,
	fiscal_year smallint,
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_department_no_vendor to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  

  CREATE VIEW aggregateon_contracts_department_no_vendor AS
  	SELECT aggregateon_contracts_department_no_vendor__0.document_code_id, aggregateon_contracts_department_no_vendor__0.agency_id,aggregateon_contracts_department_no_vendor__0.department_id,aggregateon_contracts_department_no_vendor__0.fiscal_year, 
  	aggregateon_contracts_department_no_vendor__0.fiscal_year_id,aggregateon_contracts_department_no_vendor__0.award_method_id,aggregateon_contracts_department_no_vendor__0.industry_type_id, aggregateon_contracts_department_no_vendor__0.award_size_id, aggregateon_contracts_department_no_vendor__0.spending_amount_disb,aggregateon_contracts_department_no_vendor__0.spending_amount,aggregateon_contracts_department_no_vendor__0.total_contracts,aggregateon_contracts_department_no_vendor__0.status_flag,aggregateon_contracts_department_no_vendor__0.type_of_year
  	FROM   aggregateon_contracts_department_no_vendor__0;
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.contracts_spending_transactions to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  ...
  CREATE VIEW contracts_spending_transactions AS
  	...
  	contracts_spending_transactions__0.disb_master_agreement_id,contracts_spending_transactions__0.disb_fiscal_year_id,contracts_spending_transactions__0.disb_check_eft_issued_cal_month_id,contracts_spending_transactions__0.disb_disbursement_number, contracts_spending_transactions__0.disb_agreement_commodity_line_number,
  	contracts_spending_transactions__0.oge_contract_number, contracts_spending_transactions__0.oge_budget_name,contracts_spending_transactions__0.status_flag,contracts_spending_transactions__0.type_of_year
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_contracts_expense to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';	
...
CREATE EXTERNAL WEB TABLE contracts_detailed_transactions__0(
  original_agreement_id bigint,
  contract_number character varying,
  document_code_id smallint,
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.contracts_detailed_transactions to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
 

  CREATE VIEW contracts_detailed_transactions AS
  	SELECT contracts_detailed_transactions__0.original_agreement_id, contracts_detailed_transactions__0.contract_number, contracts_detailed_transactions__0.document_code_id,contracts_detailed_transactions__0.document_code, contracts_detailed_transactions__0.description, contracts_detailed_transactions__0.document_version, contracts_detailed_transactions__0.fiscal_year, contracts_detailed_transactions__0.fiscal_year_id, 	contracts_detailed_transactions__0.agency_id, contracts_detailed_transactions__0.agency_name, contracts_detailed_transactions__0.vendor_id, contracts_detailed_transactions__0.vendor_name,   		contracts_detailed_transactions__0.award_method_id,  contracts_detailed_transactions__0.industry_type_id, contracts_detailed_transactions__0.award_size_id, contracts_detailed_transactions__0.agreement_type_name, contracts_detailed_transactions__0.award_method_name, contracts_detailed_transactions__0.expenditure_object_names,contracts_detailed_transactions__0.expenditure_object_codes, contracts_detailed_transactions__0.agreement_type_code, contracts_detailed_transactions__0.master_contract_number, contracts_detailed_transactions__0.effective_begin_date, contracts_detailed_transactions__0.effective_end_date, contracts_detailed_transactions__0.registered_date, contracts_detailed_transactions__0.brd_awd_no, contracts_detailed_transactions__0.tracking_number, contracts_detailed_transactions__0.industry_type_name, contracts_detailed_transactions__0.dollar_difference, contracts_detailed_transactions__0.percent_difference, contracts_detailed_transactions__0.starting_year_id, contracts_detailed_transactions__0.ending_year_id, contracts_detailed_transactions__0.registered_year_id, contracts_detailed_transactions__0.effective_begin_year_id, contracts_detailed_transactions__0.effective_end_year_id, contracts_detailed_transactions__0.fms_commodity_line,  contracts_detailed_transactions__0.oge_contract_number, contracts_detailed_transactions__0.budget_name, contracts_detailed_transactions__0.original_contract_amount, contracts_detailed_transactions__0.maximum_contract_amount, contracts_detailed_transactions__0.current_amount_for_transaction, contracts_detailed_transactions__0.spending_amount_disb, contracts_detailed_transactions__0.agreement_id, contracts_detailed_transactions__0.master_agreement_id,contracts_detailed_transactions__0.display_agency_id, contracts_detailed_transactions__0.display_vendor_id, contracts_detailed_transactions__0.has_children, contracts_detailed_transactions__0.master_agreement_yn, contracts_detailed_transactions__0.is_vendor_flag, contracts_detailed_transactions__0.if_for_all_years, contracts_detailed_transactions__0.latest_flag, contracts_detailed_transactions__0.status_flag, contracts_detailed_transactions__0.type_of_year 
  	FROM  contracts_detailed_transactions__0;

/*	
CREATE EXTERNAL WEB TABLE contracts_detailed_transactions_mag_vendor__0(
  original_agreement_id bigint,
  contract_number character varying,
  document_code_id smallint,
  document_code character varying(8),
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.contracts_detailed_transactions_mag_vendor to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';

  CREATE VIEW contracts_detailed_transactions_mag_vendor AS
  	SELECT contracts_detailed_transactions_mag_vendor__0.original_agreement_id, contracts_detailed_transactions_mag_vendor__0.contract_number, contracts_detailed_transactions_mag_vendor__0.document_code_id,contracts_detailed_transactions_mag_vendor__0.document_code, contracts_detailed_transactions_mag_vendor__0.description, contracts_detailed_transactions_mag_vendor__0.document_version, contracts_detailed_transactions_mag_vendor__0.fiscal_year, contracts_detailed_transactions_mag_vendor__0.fiscal_year_id, 	contracts_detailed_transactions_mag_vendor__0.agency_id, contracts_detailed_transactions_mag_vendor__0.agency_name, contracts_detailed_transactions_mag_vendor__0.vendor_id, contracts_detailed_transactions_mag_vendor__0.vendor_name,  contracts_detailed_transactions_mag_vendor__0.award_method_id,  contracts_detailed_transactions_mag_vendor__0.industry_type_id, contracts_detailed_transactions_mag_vendor__0.award_size_id, contracts_detailed_transactions_mag_vendor__0.agreement_type_name, contracts_detailed_transactions_mag_vendor__0.award_method_name, contracts_detailed_transactions_mag_vendor__0.expenditure_object_names, contracts_detailed_transactions_mag_vendor__0.expenditure_object_codes, contracts_detailed_transactions_mag_vendor__0.agreement_type_code, contracts_detailed_transactions_mag_vendor__0.master_contract_number,contracts_detailed_transactions_mag_vendor__0.effective_begin_date, contracts_detailed_transactions_mag_vendor__0.effective_end_date, contracts_detailed_transactions_mag_vendor__0.registered_date, contracts_detailed_transactions_mag_vendor__0.brd_awd_no, contracts_detailed_transactions_mag_vendor__0.tracking_number, contracts_detailed_transactions_mag_vendor__0.industry_type_name, contracts_detailed_transactions_mag_vendor__0.dollar_difference, contracts_detailed_transactions_mag_vendor__0.percent_difference, contracts_detailed_transactions_mag_vendor__0.starting_year_id, contracts_detailed_transactions_mag_vendor__0.ending_year_id, contracts_detailed_transactions_mag_vendor__0.registered_year_id, contracts_detailed_transactions_mag_vendor__0.effective_begin_year_id, contracts_detailed_transactions_mag_vendor__0.effective_end_year_id, contracts_detailed_transactions_mag_vendor__0.fms_commodity_line,  contracts_detailed_transactions_mag_vendor__0.oge_contract_number, contracts_detailed_transactions_mag_vendor__0.budget_name, contracts_detailed_transactions_mag_vendor__0.original_contract_amount, contracts_detailed_transactions_mag_vendor__0.maximum_contract_amount, contracts_detailed_transactions_mag_vendor__0.spending_amount_disb, contracts_detailed_transactions_mag_vendor__0.agreement_id, contracts_detailed_transactions_mag_vendor__0.master_agreement_id,contracts_detailed_transactions_mag_vendor__0.display_agency_id, contracts_detailed_transactions_mag_vendor__0.display_vendor_id, contracts_detailed_transactions_mag_vendor__0.has_children, contracts_detailed_transactions_mag_vendor__0.master_agreement_yn, contracts_detailed_transactions_mag_vendor__0.status_flag, contracts_detailed_transactions_mag_vendor__0.type_of_year 
  	FROM  contracts_detailed_transactions_mag_vendor__0;
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.agreement_snapshot to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  ...
  CREATE VIEW agreement_snapshot AS
  	SELECT agreement_snapshot__0.original_agreement_id,agreement_snapshot__0.document_version,agreement_snapshot__0.document_code_id,
  		...
  		agreement_snapshot__0.registered_date,agreement_snapshot__0.registered_date_id,agreement_snapshot__0.brd_awd_no,agreement_snapshot__0.tracking_number,agreement_snapshot__0.rfed_amount, agreement_snapshot__0.oge_agency_id,agreement_snapshot__0.oge_agency_name, 
...
EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.agreement_snapshot_cy to stdout csv"' ON SEGMENT 0 
     FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
  ENCODING 'UTF8';
  ...
  CREATE VIEW agreement_snapshot_cy AS
  	SELECT agreement_snapshot_cy__0.original_agreement_id,agreement_snapshot_cy__0.document_version,agreement_snapshot_cy__0.document_code_id,
  		...
  		agreement_snapshot_cy__0.registered_date,agreement_snapshot_cy__0.registered_date_id,agreement_snapshot_cy__0.brd_awd_no,agreement_snapshot_cy__0.tracking_number,agreement_snapshot_cy__0.rfed_amount, agreement_snapshot_cy__0.oge_agency_id, agreement_snapshot_cy__0.oge_agency_name, 
...
CREATE EXTERNAL WEB TABLE pending_contracts__0(
 ...
 EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.pending_contracts to stdout csv"' ON SEGMENT 0 
      FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
   ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE ref_industry_type__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_industry_type to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE VIEW ref_industry_type AS
  ...
  CREATE EXTERNAL WEB TABLE ref_award_size__0 (
    ...
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_award_size to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE VIEW ref_award_size AS
  ...
  CREATE EXTERNAL WEB TABLE ref_award_category_industry__0 (
    ...
    industry_type_id smallint,
    created_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.ref_award_category_industry to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.aggregateon_budget_by_year to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.transactions_data_by_year to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE edc_contract__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.edc_contract to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE tdc_contract__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.tdc_contract to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE oge_contract__0 (
    ...
    created_date timestamp without time zone,
    updated_date timestamp without time zone
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.oge_contract to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';
...
CREATE EXTERNAL WEB TABLE oge_contract_vendor_level__0 (	
	fms_contract_number character varying,	
	agency_code character varying(4),
	agency_id smallint,
	agency_name character varying(100),
	...
	original_amount numeric(16,2),
	current_amount numeric(16,2)
) EXECUTE E' psql -h mdw1 -p 5432  checkbook_ogent -c "copy public.oge_contract_vendor_level to stdout csv"' ON SEGMENT 0 
 FORMAT 'csv' (delimiter E',' null E'' escape E'"' quote E'"')
ENCODING 'UTF8';

 CREATE VIEW oge_contract_vendor_level AS
    SELECT oge_contract_vendor_level__0.fms_contract_number, oge_contract_vendor_level__0.agency_code,  oge_contract_vendor_level__0.agency_id, 
	oge_contract_vendor_level__0.agency_name, oge_contract_vendor_level__0.agency_history_id, oge_contract_vendor_level__0.vendor_id,    
	oge_contract_vendor_level__0.vendor_history_id, oge_contract_vendor_level__0.vendor_name, oge_contract_vendor_level__0.original_amount, 
	oge_contract_vendor_level__0.current_amount
    FROM  oge_contract_vendor_level__0;
---------------------------------------------------------END OGE Tables--------------------------------------------------------------------------------